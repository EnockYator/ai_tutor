...
Revision ID: 147fd4e9564f
Revises: 872097cf3d05
Create Date: 2025-04-27 09:43:55.383661+00:00
...
revision: str = '147fd4e9564f'
down_revision: Union[str, None] = '872097cf3d05'
...
def upgrade() -> None:
    ...
    op.drop_table('cats')
    op.drop_table('cat_attempts')
    op.drop_table('courses')
    op.drop_table('cat_questions')
    op.drop_table('users')
    op.drop_table('ai_feedback')
    op.drop_table('enrollments')
    op.drop_table('cat_answers')
...
def downgrade() -> None:
    ...
    op.create_table('cat_answers',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('cat_attempt_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('cat_question_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('selected_answer', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('is_correct', sa.BOOLEAN(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['cat_attempt_id'], ['cat_attempts.id'], name='cat_answers_cat_attempt_id_fkey'),
    sa.ForeignKeyConstraint(['cat_question_id'], ['cat_questions.id'], name='cat_answers_cat_question_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='cat_answers_pkey')
    )
    ...
    op.create_table('cat_questions',
    sa.Column('id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('cat_id', sa.UUID(), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['cat_id'], ['cats.id'], name='cat_questions_cat_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='cat_questions_pkey')
    )
    ...
    sa.ForeignKeyConstraint(['cat_id'], ['cats.id'], name='cat_attempts_cat_id_fkey'),
    sa.ForeignKeyConstraint(['student_id'], ['users.id'], name='cat_attempts_student_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='cat_attempts_pkey')
    )
    ...
    sa.Column('tutor_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['course_id'], ['courses.id'], name='cats_course_id_fkey'),
    sa.ForeignKeyConstraint(['tutor_id'], ['users.id'], name='cats_tutor_id_fkey'),
